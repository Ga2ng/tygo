      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 py-12 sm:gap-12 sm:px-10 lg:px-12 lg:py-20 max-[320px]:gap-6 max-[320px]:px-3 max-[320px]:py-10">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-6 md:grid-cols-2 max-[360px]:grid-cols-1 max-[360px]:gap-3">
          {steps.map((step, index) => (
            <div
              key={step.title}
              className="group flex transform flex-col gap-2 rounded-3xl border-4 border-black bg-white p-3 text-black shadow-[8px_8px_0_rgba(0,0,0,1)] transition-all duration-200 -translate-x-2 -translate-y-2 hover:translate-x-0 hover:translate-y-0 hover:shadow-[4px_4px_0_rgba(0,0,0,1)] sm:gap-4 sm:p-6 sm:shadow-[10px_10px_0_rgba(0,0,0,1)] max-[360px]:rounded-2xl max-[360px]:border-3"
            >
