    ...
    <div className="relative w-full overflow-hidden py-4 sm:py-5">
      ...
      <div className="relative bg-[#ff9302] py-3 sm:py-4">
        <Marquee gradient={false} speed={55} className="uppercase">
          <div className="flex items-center gap-4 px-4 text-base font-black tracking-[0.15em] text-black sm:gap-6 sm:px-6 sm:text-lg sm:tracking-[0.22em] md:gap-8 md:px-8 md:text-2xl md:tracking-[0.28em] lg:text-3xl lg:tracking-[0.3em] font-freeman">
